 ...
 */
public class SsidVerification extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                verify(ssid);
                Intent intent = new Intent(SsidVerification.this, WelcomePage.class);
                SsidVerification.this.startActivity(intent);
            }
        });
